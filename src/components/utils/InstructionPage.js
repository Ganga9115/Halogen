...
const instructionsData = {
  social: {
    english: [
      "The game has 2 levels, and each level has 4 questions. The total time to finish the game is 180 seconds.",
    ...
    tamil: [
      "விளையாட்டில் 2 நிலைகள் உள்ளன, ஒவ்வொரு நிலையிலும் 4 கேள்விகள் உள்ளன. முழு விளையாட்டை முடிக்க 180 விநாடிகள் மட்டுமே தரப்படுகிறது.",
      ...
      "விளையாட்டை தமிழில் மொழிபெயர்க்க Toggle பொத்தானை பயன்படுத்தலாம்."
    ]
  },
  tamil: {
    english: [
      "Objective – Flip the cards and match pairs of Grammer or Poem-Poet.",
      "How to Play – On each turn, flip two cards. If they are a correct pair, they remain open. Otherwise, they flip back.",
    ...
    tamil: [
      "நோக்கம் – அட்டைகளை புரட்டி, மொழியியல் அல்லது கவிதை-கவிஞர் ஜோடியை பொருத்தவும்.",
      "விளையாடும் முறை – ஒவ்வொரு சுற்றிலும் இரண்டு அட்டைகளைத் திறக்கவும். அவை சரியான ஜோடி என்றால் திறந்தபடி இருக்கும்; இல்லை என்றால் மீண்டும் மூடப்படும்.",
  ...
  math: {
    english: [
      ...
      "Answer to Rescue – You must answer 8 questions correctly to stop the water from rising.",
      "Timer Rule – The water level increases gradually with time. Answer quickly to reduce the risk.",
      "Game Over – If you fail to answer 8 questions within the given time, the girl will drown."
    ],
    tamil: [
      "பணி – ஒரு பெண் தண்ணீர் தொட்டியில் சிக்கி உள்ளாள். தொட்டி நிரம்புவதற்கு முன் அவளை காப்பாற்ற வேண்டும்.",
      "விடை அளித்து காப்பாற்று – தண்ணீர் உயரும் முன்னர் 8 கேள்விகளுக்கு சரியான விடை அளிக்க வேண்டும்.",
      "நேர விதி – நேரம் செல்ல செல்ல தண்ணீரின் அளவு மெதுவாக அதிகரிக்கும். விரைவாக பதில் அளியுங்கள்.",
      "விளையாட்டு முடிவு – கொடுக்கப்பட்ட நேரத்திற்குள் 8 கேள்விகளுக்கு விடை அளிக்கத் தவறினால், பெண் மூழ்கி விடுவாள்."
    ]
  },
  science: {
    english: [
      "The game has 8 riddles in total. You must solve them before the timer (180 seconds) runs out.",
      ...
      "At the end of the game, your score will be displayed out of 80, along with the leaderboard 🏆."
    ],
    tamil: [
      "விளையாட்டில் 8 விடுகதைகள் உள்ளன, அவற்றை 180 வினாடிகளில் தீர்க்க வேண்டும்.",
